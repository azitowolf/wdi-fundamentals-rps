...
function getPlayerMove(move) {
    ...
    if(move.toUpperCase() === "ROCK"){
        return "ROCK"
    } else if (move.toUpperCase() === "PAPER"){
        return "PAPER"
    } else if (move.toUpperCase() === "SCISSORS") {
        return "SCISSORS"
    }
    return getInput();
}
...
function playToFive() {
    ...
    var playerMove = getInput().toUpperCase();
    var computerMove = randomPlay().toUpperCase();
